...
<div id="page-wrapper">
    ...
    <!-- Write code here-->
           ...
           <div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        <div class="form-ti3'tle">
                            <h4>Search For Animal</h4>
                        </div>
                    <form class="form-horizontal" action="st_anml_retrieved.html" method="post">
                    <div class="form-body">
                    <div class="form-group">
                        Animal Data:<input class="form-control1" type="text" name="id" id="s1"/>
                    </div>
                    <div class="form-group">
